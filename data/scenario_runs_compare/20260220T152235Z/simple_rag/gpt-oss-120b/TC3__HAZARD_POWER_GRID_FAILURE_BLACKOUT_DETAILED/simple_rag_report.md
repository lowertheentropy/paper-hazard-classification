...
### Memory
```
[Memory:1 #000081 On scene] FL M 2/46/1: Heavy smoke from the cable duct/cable route, firefighting in progress; danger from hazardous gases still persists, Status 4.

[Memory:2 #000086 Dispatch center/situation] Dispatch center: Citywide power outage. Mobile network unstable, traffic lights down, multiple reports of elevator emergencies. Grid operator reports rising outage numbers, with partial restoration in some streets/blocks.
```
