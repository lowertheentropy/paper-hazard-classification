...
### Memory
```
[Memory:1 #000092 Situation note] Harbor master: After a noticeable earthquake, the lake’s water level is oscillating rhythmically. Boats are repeatedly striking the pier/dock, lines are snapping. No tsunami—this is an inland body of water.
```
