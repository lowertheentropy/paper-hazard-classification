...
**Direct Answer**
```json
{"hazard_id":"hazards:Hazard_Tornado","label":"Tornado","confidence":0.9,"evidence":["[Snippet] 1070082,2021-6-29 01:12:00,2021-06-29 1:45:00,IOWA,Tornado,0,EF,41.74,-98.836,0,0,249207,0","[Knowledge:193 hazards:Hazard_Tornado Tornado]"] ,"notes":"The snippet contains a record with EVENT_TYPE='Tornado', which directly matches the Tornado hazard definition."}
