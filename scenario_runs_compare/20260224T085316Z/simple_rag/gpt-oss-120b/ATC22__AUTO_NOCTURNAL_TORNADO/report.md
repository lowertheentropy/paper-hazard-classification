...
**Direct Answer**
```json
{"hazard_id":"hazards:Hazard_Storm","label":"Storm","confidence":0.93,"evidence":["[Knowledge:179 hazards:Hazard_Storm Storm] HAZARD_ID: hazards:Hazard_Storm LABEL: Storm … Keywords: storm (general).","SNIPPET shows EVENT_TYPE values Hail, Tornado, Winter Storm – all sub‑types of a general storm event."]} 
```
